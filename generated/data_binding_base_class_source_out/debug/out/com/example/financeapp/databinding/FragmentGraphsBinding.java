...
public final class FragmentGraphsBinding implements ViewBinding {
  ...
  private FragmentGraphsBinding(@NonNull MaterialCardView rootView, @NonNull PieChart pieChart) {
  ...
  public static FragmentGraphsBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new FragmentGraphsBinding((MaterialCardView) rootView, pieChart);
    }
